    ...
    >
      ...
      <div
        style={{
          ...
          height: 120,
          background:
            "radial-gradient(ellipse, rgba(0,212,170,0.18) 0%, transparent 70%)",
          filter: "blur(20px)",
          pointerEvents: "none",
          zIndex: 0,
        }}
      ...
      <div
        style={{
          ...
          overflow: "hidden",
          boxShadow:
            "0 32px 80px rgba(0,0,0,0.7), 0 0 0 1px var(--border-subtle)",
          position: "relative",
          zIndex: 1,
        }}
      >
      ...
      <section className="hero-section" aria-label="Hero">
        ...
        <div
          style={{
            ...
            height: 500,
            background:
              "radial-gradient(ellipse at 50% 0%, rgba(0,212,170,0.10) 0%, transparent 65%)",
            pointerEvents: "none",
            zIndex: 0,
          }}
        />
        ...
        >
          ...
          <FadeUp delay={0.2}>
            <p className="hero-sub">
              Memoize auto-captures every accepted submission and uses the SM-2
              algorithm to schedule reviews at the exact moment you'd forget —
              so your prep compounds instead of leaking.
            </p>
          </FadeUp>
        ...
        trackEvent(ANALYTICS_EVENTS.CHROME_STORE_CTA_CLICKED, {
          ...
          destination: "chrome_web_store",
            ...
            <p className="hero-microcopy">
              Manual install via chrome://extensions · GitHub or Google sign-in
              · No credit card
            </p>
          </FadeUp>
